...
- Поиск Парето-оптимальных активов (эффективная граница)
- Оценка Value at Risk (VaR 95%) и Conditional VaR (CVaR 95%)
- Тестирование гипотезы случайности доходностей (Ljung-Box)
- Проверка нормальности распределения доходностей (Shapiro-Wilk, Jarque-Bera, Q-Q plots)
- Исследование альтернативных распределений (StudentT, Laplace, GED, Logistic) 
